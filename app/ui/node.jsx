...
export default function Node(props) {
  ...
  return (
    <div className={(props.data.complete ? "opacity-50 " : "opacity-100 ") + (active[0] ? "cursor-default " : "") + "px-6 py-3 bg-neutral-100 border border-black dark:bg-neutral-800 dark:border-neutral-500 rounded-lg"}>
...
function Handle(props) {
  ...
  return <FlowHandle {...props} className={(active[0] ? "!cursor-default " : "!cursor-grab ") + "!bg-black dark:!bg-neutral-500 !border-white dark:!border-neutral-950"} />
}