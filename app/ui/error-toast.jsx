...
export default function ErrorToast({ error, alwaysDark = false }) {
  return (
    <motion.div
      ...
      className={"lg:w-auto w-[80vw] absolute left-1/2 -translate-x-1/2 bottom-8 z-50 px-3 py-2 flex justify-center items-center gap-3 rounded-full " + (alwaysDark ? "bg-red-300" : "bg-red-800 dark:bg-red-300")}
    >
